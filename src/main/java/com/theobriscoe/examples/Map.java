...
import com.theobriscoe.examples.common.Bird;
...
public class Map {
  ...
  public static void main(String[] args) {
    ...
    // Map (aka Convert) People to Birds
    people.stream()
        .filter(person -> person.getGender() == Gender.MALE)
        .map(person -> new Bird(person.getName().toUpperCase(), person.getGender(), person.getAge()))
        .forEach(System.out::println);
